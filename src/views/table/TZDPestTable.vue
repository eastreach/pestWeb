...
<script>
  ...
  import TZDPestForm from '../form/TZDPestForm.vue';
  export default {
    ...
    methods: {
      ...
      selectPage() {
        let self = this;
        self.loading = true;
        self.$http.post(self.gatewayUrl + '/pest/selectPage', {
      ...
      update(){
        ...
        self.$confirm('是否继续操作', '提示', {
          ...
          self.$http.post(self.gatewayUrl + '/pest/updateBatch', {
            tzdOperator: self.$store.state.tzdOperator,
      ...
      delete(){
        ...
        self.$confirm('是否继续操作', '提示', {
          ...
          self.$http.post(self.gatewayUrl + '/pest/deleteBatch', {
            tzdOperator: self.$store.state.tzdOperator,
            tzdPestList: JSON.stringify(self.multipleSelection),
          }).then((res) => {
            if (res.data.state === "success") {
