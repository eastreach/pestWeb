...
<script>
  ...
  import TPublishInfoForm from '../form/TPublishInfoForm.vue';
  export default {
    ...
    methods: {
      ...
      selectPage() {
        let self = this;
        self.loading = true;
        self.$http.post(self.gatewayUrl + '/publishInfo/selectPage', {
      ...
      update(){
        ...
        self.$confirm('是否继续操作', '提示', {
          ...
          self.$http.post(self.gatewayUrl + '/publishInfo/updateBatch', {
            tzdOperator: self.$store.state.tzdOperator,
            tPublishInfoList: JSON.stringify(self.multipleSelection),
          }).then((res) => {
            if (res.data.state === "success") {
      ...
      delete(){
        ...
        self.$confirm('是否继续操作', '提示', {
          ...
          self.$http.post(self.gatewayUrl + '/publishInfo/deleteBatch', {
            tzdOperator: self.$store.state.tzdOperator,
            tPublishInfoList: JSON.stringify(self.multipleSelection),
          }).then((res) => {
            if (res.data.state === "success") {
