<template>
  ...
  <div class="fj_wrap" v-bind:style="{ backgroundImage: bgImg}">
    <el-row class=" fj_top"
      ...
      <el-col :span="24" class="fj_top_name"
...
" v-if="n>=index&&n<5+index">
    ...
    <el-row class="fj_foot"
      ...
      <el-row class="fj_foot_bottom" v-if="carouselShow"
...
//            }, 1000);
    ...
    methods: {
      ...
      screenWidths(){
        var self = this;
        var objR = document.getElementsByClassName("fj_foot_bottom");
