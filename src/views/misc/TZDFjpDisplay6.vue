<template>
  <div class="fj_wrap" v-bind:style="{  backgroundImage: bgImg,fontFamily:fontfamily }">
    ...
    <el-row class="fj_content"
            v-bind:style="{ background:  bgContent }">
            ...
            <el-carousel-item v-for="(item,index) in tableData" :key="item.id" v-if="(index%5==0)">
              <table>
                ...
                <tr    v-for="(item,n) in tableData" :key="item.id" v-if="n>=index&&n<5+index">
                  <td v-bind:style="{ background:bgprice }" v-for="fileditem in  tableFiled">{{tableData[n][fileditem.name]}}</td>
                </tr>
    ...
    <el-row class="fj_foot"
            v-bind:style="{ background:bgFoot }">
      <el-col :span="6" style=" background: rgba(255, 255, 255, 0.1); height: 100%;"
        ...
        self.$http.post(self.url, {
          ...
          if (res.data.state == "success") {
            ...
            if (value.indexOf("hotelName") > 0) {
              ...
              self.fontfamily = res.data.data.value.fontfamily;
              ...
              self.bgprice=res.data.data.value.bgprice;
